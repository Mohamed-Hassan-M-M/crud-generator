...
class CrudControllerCommand extends GeneratorCommand
{
    ...
    protected $signature = 'crud:controller
                            ...
                            {--translatableArray= : The names of the translatable columns as array.}
                            {--translatableWithCode= : The names of the translatable columns with _code.}
    ...
    protected function buildClass($name)
    {
        ...
        $translatable = $this->option('translatable');//edit mhmm
        $translatableArray = $this->option('translatableArray');//edit mhmm
        $translatableWithCode = $this->option('translatableWithCode');//edit mhmm
...
EOD;
    ...
    protected function replaceTranslatable(&$stub, $translatableWithCode, $translatable)//mhmm
    {
        $stub = str_replace('{{translatable}}', $translatable, $stub);
        $stub = str_replace('{{translatableWithCode}}', $translatableWithCode, $stub);
        return $this;
    }
